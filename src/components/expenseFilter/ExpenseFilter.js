  ...
  return(
    <div className="relative">
      <div className="flex items-center border border-gray-300 shadow bg-white mb-2 rounded-lg">
        <input type="text" className="p-2 border-none focus:outline-none rounded-lg" value={props.selectedYear} readOnly/>
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M19 9l-7 7-7-7" />
        </svg>
      </div>
      <div className="max-h-40  h-40 flex flex-col w-full rounded-lg absolute shadow-xl">
